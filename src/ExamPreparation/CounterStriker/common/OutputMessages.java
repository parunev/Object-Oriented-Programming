...
public class OutputMessages {
    ...
    public static final String PLAYER_TO_STRING = "%s: %s";

    public static final String PLAYER_HEALTH_TO_STRING = "--Health: %d";

    public static final String PLAYER_ARMOR_TO_STRING = "--Armor: %d";

    public static final String PLAYER_GUN_TO_STRING = "--Gun: %s";
}

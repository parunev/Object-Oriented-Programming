...
import static CounterStriker.src.CounterStriker.common.OutputMessages.COUNTER_TERRORIST_WINS;
import static CounterStriker.src.CounterStriker.common.OutputMessages.TERRORIST_WINS;
...
public class FieldImpl implements Field{
    ...
    public String start(Collection<Player> players) {
        ...
        return terrorists.size() > EMPTY_COLLECTION_SIZE
                ? TERRORIST_WINS
